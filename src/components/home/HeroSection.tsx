      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-start md:justify-center px-4 pt-[27vh] md:pt-0 pb-8 md:py-24">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl w-full">
          <div className="text-center">
            <p className="text-2xl md:text-4xl font-bold text-[hsl(42,100%,50%)]">10+</p>
            <p className="text-sm text-gray-300 mt-1">{t.stats.projects}</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-4xl font-bold text-[hsl(42,100%,50%)]">6+</p>
            <p className="text-sm text-gray-300 mt-1">{t.stats.clients}</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-4xl font-bold text-[hsl(42,100%,50%)]">1+</p>
            <p className="text-sm text-gray-300 mt-1">{t.stats.years}</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-4xl font-bold text-[hsl(42,100%,50%)]">40%</p>
            <p className="text-xs sm:text-sm text-gray-300 mt-1">{t.stats.conversion}</p>
          </div>
        </div>
      </div>
    </section>
